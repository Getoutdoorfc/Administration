...
class AdminNotices {
    ...
    public function display_admin_notices() {
        Logger::getInstance()->info('Displaying admin notices.');
        ...
        if (!empty($errors)) {
            foreach ($errors as $error) {
                ...
                Logger::getInstance()->info("Displayed notice: {$error['message']}");
            }
        }
    }
    ...
    public static function add_dynamic_notice(string $message, string $type = 'updated'): void {
        Logger::getInstance()->info("Adding dynamic notice: {$message}");
    ...
    public static function display_message(string $message, string $type = 'updated'): void {
        ...
        Logger::getInstance()->info("Displayed direct message: {$message}");
    }
    ...
    public static function clear_previous_notices(): void {
        ...
        Logger::getInstance()->info('Cleared previous notices.');
    }
}
