...
use Administration\Components\AdminInterface\MicrosoftSetup;
use Administration\Components\AdminInterface\StockOverview;
...
class Menu {
    ...
    public function __construct() {
        ...
        if (class_exists('Administration\Components\AdminInterface\StockOverview')) {
